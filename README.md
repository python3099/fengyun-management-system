...
| 模块 | 说明 |
|------|------|
| 日常待办 | 日历月视图管理每日待办（周末/法定节假日/调休标识，格内直接显示待办负责人），支持增删改查 |
| 运营情况 | 公司运营核心指标自动汇总 + 各部门看板（部门包含多份合同，自动聚合，按合同总额排序） |
| 进度卡点 | 部门卡点问题表格化跟踪（未开始/进行中/待推进/已解决），支持拖拽排序 |
| 来年统采 | 已落地 / 潜在合作 / 未对接三级清单（表格化展示），支持拖拽排序，未对接重点高亮 |
